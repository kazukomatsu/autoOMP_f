...
namespace AutoParallelization
{
  ...
  //std::vector<SgInitializedName*> RecognizeReduction(SgNode *sg_node, OmpSupport::OmpAttribute* attribute);
  ...
  void uniformIndirectIndexedArrayRefs (SgForStatement* for_loop);
  void collectIndirectIndexedArrayReferences(SgNode* loop,  std::map<SgNode*, bool>& indirect_array_table);
